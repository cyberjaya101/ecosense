...
class HomeScreenState extends State<HomeScreen> {
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          ...
          content: Text('Room Verified: Lounge! Reports now worth 50 Points.'),
        ),
      );
    }
  }
  ...
  Future<void> _triggerGhostFlow() async {
    ...
    // 2. Show "Gemini Vision Scanning" Dialog
    if (!mounted) return;
    showDialog(
      context: context,
      barrierDismissible: false,
      builder: (context) => AlertDialog(
        backgroundColor: const Color(0xFF1B151D),
        shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(20),
            side: const BorderSide(color: Color(0xFF00E5FF), width: 1)),
        title: Text('Gemini Vision AI',
            style: GoogleFonts.interTight(
                color: const Color(0xFFF2EAF7), fontWeight: FontWeight.bold)),
        content: Column(
          ...
          children: [
            ...
            Text('Analyzing photo for human presence...',
                ...
                style: GoogleFonts.inter(color: const Color(0xFFC59DD9))),
          ],
        ),
      ),
    );
    ...
    // 4. Submit Report with real image data
    try {
      // Simulate at least 3.5s of "AI Scanning" for demo effect
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          backgroundColor: Colors.green,
          content: Text(
              'Gemini Vision: Verified Empty! +150 Points Pending Admin Approval.'),
        ),
      );
    }
  }
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          StreamBuilder<int>(
                            stream: _service.unreadNotificationsCountStream(),
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      _useQR
                                          ? '50 Point Reward Eligible'
                                          : 'Point camera to verify location',
                                      style: GoogleFonts.inter(
                                          fontSize: 14,
                                          color: const Color(0xFFC59DD9))),
                                ],
                  ...
                  // 7. Submit Button (Vibrant Eco-Green)
                  GestureDetector(
  ...
  Widget _buildIssueCard({
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: isDisabled ? null : () => setState(() => _selectedIssue = type),
        child: AnimatedContainer(
          duration: const Duration(milliseconds: 250),
          padding: const EdgeInsets.all(20),
          decoration: BoxDecoration(
            color:
                isSelected ? const Color(0xFF2D1B36) : const Color(0xFF1B1B1E),
